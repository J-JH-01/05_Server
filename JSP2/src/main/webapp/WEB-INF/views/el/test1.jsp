...
<body>
	...
	<h3>EL은 자료형 변환(parsing)을 자동 수행해 준다</h3>
	...
	<ul>
	<li><%-- check가 여러개 절달 된 경우 첫번째 값 출력 --%>
		param.check : ${param.check }</li>
	
	<LI>paramValuese.check : ${paramValues.check }</LI> <%-- 배열의 주소 반환 --%>
